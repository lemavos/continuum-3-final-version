    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-8 animate-fade-in">
        ...
        <div className="bento-card p-6 space-y-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="pl-10 bg-accent border-border/50" required />
              </div>
            </div>
          ...
          <Button variant="outline" className="w-full border-border/50 hover:border-border hover:bg-accent" onClick={handleGoogleLogin}>
